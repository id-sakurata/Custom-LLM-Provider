...
export class DashboardProvider {
    public static readonly viewType = 'customLlmDashboard';

    public static createOrShow(extensionUri: vscode.Uri, registry: ModelRegistry): void {
    ...
    private static _getHtmlForWebview(webview: vscode.Webview, extensionUri: vscode.Uri, registry: ModelRegistry): string {
        ...
        return `<!DOCTYPE html>
            ...
            <body>
                <div class="header">
                    ...
                    <span class="status-badge ${ConfigManager.enabled ? 'enabled' : 'disabled'}">${ConfigManager.enabled ? 'Enabled' : 'Disabled'}</span>
